        ...
        <section className="grid md:grid-cols-2 xl:grid-cols-4 gap-6">
          ...
          <div className="flex items-center p-8 bg-white shadow-lg rounded-lg">
            ...
            <div>
              ...
              <span className="block text-gray-500">Completed Tasks</span>
            </div>
          </div>
        </section>
        ...
        <section className="grid md:grid-cols-2 xl:grid-cols-4 xl:grid-rows-3 xl:grid-flow-col gap-6 ">
          ...
          <div className="flex items-center p-8 bg-white shadow-md rounded-lg">
            ...
            <div>
              ...
              <span className="block text-gray-500">Hours Logged</span>
            </div>
          </div>
                ...
                <li className="flex items-center">
                  <div className="h-10 w-10 mr-3 bg-gray-100 rounded-full overflow-hidden">
                    <img
                      ...
                      alt="Annette Watson profile_picture"
                    />
                  </div>
                ...
                <li className="flex items-center">
                  <div className="h-10 w-10 mr-3 bg-gray-100 rounded-full overflow-hidden">
                    <img
                      ...
                      alt="Calvin Steward profile_picture"
                    />
                  </div>
                ...
                <li className="flex items-center">
                  <div className="h-10 w-10 mr-3 bg-gray-100 rounded-full overflow-hidden">
                    <img
                      ...
                      alt="Ralph Richards profile_picture"
                    />
                  </div>
